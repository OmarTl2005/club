const Activity = ({ blog }) => {
  return (
    <div className="flex items-center justify-center flex-col self-center xsm:w-full md:w-[80%] h-full">
      <h1 className="font-outfit border-b-2 mb-11 mt-8 border-b-black text-green-700 md:text-4xl xsm:text-3xl text-bold hover:-translate-y-2 cursor-pointer transition-all duration-500">{blog.top}</h1>
      <div>
