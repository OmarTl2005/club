    ...
    return (
        <main className="w-full xsm:w-full md:w-[80%] xsm:pt-[100px] md:pt-0 self-center xsm:h-full md:h-[83vh] flex flex-row items-center justify-center" >
            <section className="flex w-[4%] items-center flex-col justify-center md:mr-[30px] xsm:pl-4 md:pl-0 sm:pl-6 z-[1000000]">
                ...
                <a alt="Send an email" href="https://mail.google.com/mail/?view=cm&fs=1&to=estsportsclub@gmail.com" target="_blank" rel="noreferrer"><BiLogoGmail className="md:text-4xl xsm:text-2xl sm:text-3xl text-black mb-[15px] hover:text-[#c71610] transition-all duration-500 hover:-translate-y-2 cursor-pointer" /></a>
            </section>
