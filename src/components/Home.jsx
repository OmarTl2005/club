    ...
    return (
        <main className="w-full xsm:w-full md:w-[80%] xsm:pt-[150px] md:pt-0 self-center h-full flex flex-row items-center justify-center" >
            <section className="flex w-[4%] items-center flex-col justify-center md:mr-[30px] xsm:pl-4 md:pl-0 sm:pl-6 z-[1000000]">
                ...
                <a alt="not yet" href="/"><FaFacebook  className="md:text-4xl xsm:text-2xl sm:text-3xl text-black mb-[15px] hover:text-[#3b5998] transition-all duration-500 hover:-translate-y-2 cursor-pointer"/></a>
                <a alt="not yet" href="/"><BiLogoGmail className="md:text-4xl xsm:text-2xl sm:text-3xl text-black mb-[15px] hover:text-[#c71610] transition-all duration-500 hover:-translate-y-2 cursor-pointer" /></a>
            </section>
